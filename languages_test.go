...
func TestLanguages(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"EMPIRE STATE 2013 DVDRip TRNC English and Española Latin", []string{"en", "es-mx", "es"}},
		{"Mary Poppins Returns 2019 DVDRip LATINO-1XBET", []string{"es-mx"}},
		{"Los Simpsons S18 E01 Latino", []string{"es-mx"}},
		{"Spider-Man (2002) Blu-Ray [720p] Dual Ingles-Español", []string{"dual audio", "en", "es"}},
		{"Abuela (2015) 1080p BluRay x264 AC3 Dual Latino-Inglés", []string{"dual audio", "en", "es-mx"}},
		{"Dumbo.2019.1080p.Dual.Lat", []string{"dual audio", "es-mx"}},
		{"A.Score.to.Settle.2019.lati.mp4", []string{"es-mx"}},
		{"[S0.E04] Gambit królowej - Gra środkowa.Spanish Latin America.srt", []string{"es-mx"}},
		{"Latin American.spa.srt", []string{"es-mx"}},
		...
		{"Frieren - Beyond Journey's End - S01E01 - TBA WEBDL-1080p.Latin American es.ass", []string{"es-mx"}},
	...
	for _, tc := range []struct {
		...
		{"Godzilla.x.Kong.The.New.Empire.2024.2160p.BluRay.REMUX.DV.P7.HDR.ENG.LATINO.GER.ITA.FRE.HINDI.CHINESE.TrueHD.Atmos.7.1.H265-BEN.THE.MEN", []string{"en", "zh", "fr", "es-mx", "it", "de", "hi"}},
		{"Sampurna.2023.Bengali.S02.1080p.AMZN.WEB-DL.DD+2.0.H.265-TheBiscuitMan", []string{"bn"}},
		{"Kingdom.of.the.Planet.of.the.Apes.2024.HDRIP.1080P.[xDark [SaveHD] Latin + English + Hindi.mp4", []string{"en", "es-mx", "hi"}},
